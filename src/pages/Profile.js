...
const AdminProfilePage = () => {
    ...
    const defaultAvatar = "https://via.placeholder.com/150"; // Default placeholder image
    const defaultBanner = "https://via.placeholder.com/1200x400"; // Default banner image
